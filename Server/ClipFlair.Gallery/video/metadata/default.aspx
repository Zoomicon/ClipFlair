<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ClipFlair.Gallery.VideoMetadataPage" %>
  ...
  <body>
    ...
    <%-- INSTRUCTION BOX --%>
      ...
      <asp:Panel ID="uiMetadata" runat="server" Visible="false">
        ...
        <div class="question" id="AudioLanguage" style="float: left">
          <div class="label">3. Audio language</div>
        ...
        <div class="question" id="CaptionsLanguage" style="float: left">
          <div class="label">4. Captions language (on the clip)</div>
          <asp:Panel runat="server" 
            Height="450" Width="250"
            ScrollBars="Auto">
        ...
        <div class="question" id="Genre" style="float: left">
          <div class="label">5. Genre</div>
          <asp:Panel runat="server" 
            Height="450" Width="250"
            ScrollBars="Auto">
        ...
        <div class="question" id="Duration" style="clear: left">
          <div class="label">6. Duration (hh:mm:ss)</div>
          <asp:TextBox ID="txtDuration" runat="server"></asp:TextBox>
        </div>

        <div class="question" id="AudiovisualRichness">
          <div class="label">7. Audiovisual richness</div>
          <asp:Panel runat="server" 
        ...
        <div class="question" id="PedagogicalAdaptability">
          <div class="label">
            <asp:CheckBox ID="cbPedagogicalAdaptability" runat="server" Text="8. Pedagogical Adaptability" />
          </div>
        </div>

        <div class="question" id="AgeGroup">
          <div class="label">9. Age group</div>
