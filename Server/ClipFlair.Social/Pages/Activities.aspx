...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" Runat="Server">
  ...
  <cc2:CustomXml
   DocumentUrl="http://gallery.clipflair.net/collection/activities.cxml"
   XslUrl="http://gallery.clipflair.net/collection/activities_list.xsl"
   runat="server"
   />			 
