                    ...
                    <portal:PortalWebPartZoneTableless ID="ForthRightPartZone" runat="server" Width="100%" ChromeTemplateFile="Standard.htm" HeaderText='<%$ Code: PageResources.Zone_RightPartZone %>'>
                        <ZoneTemplate>
                            <MonoX:SlideShow runat="server" ID="ctlSlideShow" Title='<%$ Code: PageResources.Title_RightSection %>'
                                ...
                                <SlideShowItems>
                                    <ModuleGallery:SlideShowItem runat="server" ImageUrl="~/App_Themes/ClipFlair/img/Projects/agComhaireamhCountingRND.clipflair.jpg" Url="http://studio.clipflair.net/?activity=agComhaireamhCountingRND.clipflair" Title="Uimhreacha: Ag Comhaireamh sa Ghaeilge"></ModuleGallery:SlideShowItem>
                                    ...
                                    <ModuleGallery:SlideShowItem runat="server" ImageUrl="~/App_Themes/ClipFlair/img/Projects/苹果鸡翅-Cap-B2-ZH.jpg" Url="http://studio.clipflair.net/?activity=zh_Chinese-recipe1.clipflair" Title="苹果鸡翅：填空-Cap-B1-ZH"></ModuleGallery:SlideShowItem>
                                    <ModuleGallery:SlideShowItem runat="server" ImageUrl="~/App_Themes/ClipFlair/img/Projects/Espanol-A1-unidad2-LaFamilia.clipflair.jpg" Url="http://studio.clipflair.net/?activity=LaFamilia-RevCap-A1-ES-RO.clipflair" Title="Espanol-A1 La familia"></ModuleGallery:SlideShowItem>
                                    ...
                                    <ModuleGallery:SlideShowItem runat="server" ImageUrl="~/App_Themes/ClipFlair/img/Projects/PolishDances_SubtitleTheClip_Polish.clipflair.jpg" Url="http://studio.clipflair.net/?activity=Polish-dances-Cap-B1-B2-PL.clipflair" Title="Polish-dances-Cap-B1-B2-PL"></ModuleGallery:SlideShowItem>
                                    <ModuleGallery:SlideShowItem runat="server" ImageUrl="~/App_Themes/ClipFlair/img/Projects/Retro.clipflair.jpg" Url="http://studio.clipflair.net/?activity=Retro.clipflair" Title="Retro"></ModuleGallery:SlideShowItem>
                                    <ModuleGallery:SlideShowItem runat="server" ImageUrl="~/App_Themes/ClipFlair/img/Projects/UD_euskera_nornaizni.clipflair.jpg" Url="http://studio.clipflair.net/?activity=UD_euskera_nornaizni.clipflair" Title="UD_euskera_nornaizni"></ModuleGallery:SlideShowItem>
